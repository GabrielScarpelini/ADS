...
engine = create_engine('sqlite:///escola_original.db') 
#abre esse arquivo como se fosse um banco 
# o arquivo no caso é escola.db, da pasta atual
...
def inserirAluno(aluno):
    ...
    email = aluno['email']
    with engine.connect() as con:    
        sql_criar = "INSERT INTO Aluno (nome,email) VALUES (:nome,:email)"
